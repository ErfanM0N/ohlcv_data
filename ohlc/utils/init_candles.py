import logging
from ohlc.models import Candle15M, Candle1H, Candle4H
...
def init_15m_candles(client: Client, asset: Asset, from_year: int = 2022, from_month: int = 1, from_day: int = 1):
...
def init_1h_candles(client: Client, asset: Asset, from_year: int = 2020, from_month: int = 1, from_day: int = 1):
    start_time = int(datetime(from_year, from_month, from_day, 0, 0, 0, tzinfo=timezone.utc).timestamp() * 1000)
...
def init_4h_candles(client: Client, asset: Asset, from_year: int = 2018, from_month: int = 1, from_day: int = 1):
    start_time = int(datetime(from_year, from_month, from_day, 0, 0, 0, tzinfo=timezone.utc).timestamp() * 1000)
